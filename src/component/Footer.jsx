  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
    <div className="mx-auto max-w-md">
      <strong className="block text-center text-xl font-bold text-gray-100 sm:text-3xl">
        Want us to email you with the latest Dark_Buster news?
      </strong>
      ...
      <form className="mt-6">
        <div className="relative max-w-lg">
          ...
          <button
            className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-zinc-900 px-5 py-3 text-sm font-medium text-white transition hover:bg-zinc-700"
          >
            Subscribe
          </button>
        </div>
   ...
   className="text-gray-200 transition hover:text-gray-200/75"
      ...
      <div className="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
        ...
        <div>
          ...
          <ul className="mt-6 space-y-1">
            ...
            <li>
              <a className="text-gray-100 transition hover:text-gray-100/75" href="/"> Our Team </a>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-6 space-y-1">
            ...
            <li>
              <a className="text-gray-100 transition hover:text-gray-100/75" href="/"> Contact </a>
            </li>

            <li>
              <a className="text-gray-100 transition hover:text-gray-100/75" href="/"> Live Chat </a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div className="mt-16 border-t border-gray-100 pt-8">
      <p className="text-center text-xs/relaxed text-gray-500">
        ...
        Created with
        <a href="" className="text-gray-700 underline transition hover:text-gray-700/75"> Code Hustlerz </a>
        and
